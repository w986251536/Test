        ...
        <div class="form-group">
          <div class="input-group">
            <span class="input-group-btn">
              <button onclick="search()" type="button" class="btn btn-sm bg-white btn-icon rounded"><i class="fa fa-search"></i></button>
            </span>
            <div>
            ...
            <select id="school" style="width: 125px; position: absolute; left: 320px; top: 5px;">
            	...
            	<option value="3">蓝调</option>
            	<option value="4">古典</option>
            	<option value="5">爵士</option>
            	<option value="6">嘻哈</option>
            	<option value="7">金属</option>
            </select>
            </div>
       
		    	<c:forEach items="${requestScope.mvlist}" var="mvlist">
                     <a href="#">${mvlist.mvname}</a>
                </c:forEach>
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle bg clear" data-toggle="dropdown">
              <span class="thumb-sm avatar pull-right m-t-n-sm m-b-n-sm m-l-sm">
                <img src="<%=basepath %>/chahua/images/a0.png" alt="...">
              </span>
              八轮车<b class="caret"></b>
            </a>
            <ul class="dropdown-menu animated fadeInRight">            
              ...
              <li class="divider"></li>
              <li>
                <a href="" data-toggle="ajaxModal" >登出</a>
              </li>
            </ul>
          </li>
        </ul>
              ...
              <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px" data-railOpacity="0.2">
                ...
                <nav class="nav-primary hidden-xs">
                  <ul class="nav bg clearfix">
                    ...
                    <li>
                      <a href="javascript:changeIframeUrl('<%=basepath %>/chahua/listen.jsp')">
                        <i class="icon-list icon  text-info-dker"></i>
                        <span class="font-bold">音乐列表</span>
                      </a>
                    </li>
                    <li>
                      <a href="javascript:changeIframeUrl('<%=basepath %>/chahua/video.jsp?list=${requestScope.mvlist}')" data-target="#content" data-el="#bjax-el" data-replace="true">
